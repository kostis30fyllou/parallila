...
class ParallelProcess {
    ...
    void update(int ix, int iy, float* u1, float* u2);
...
public:
    ...
    // Heat functions
    void inidat();
    void inner_update(int iz);
    void outer_update(int iz);
...
inline void ParallelProcess::update(int ix, int iy, float* u1, float* u2) {
...
inline void ParallelProcess::inner_update(int iz) {
...
inline void ParallelProcess::outer_update(int iz) {
