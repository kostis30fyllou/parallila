...
#PBS -l nodes=8:ppn=4 			# 8 nodes with 8 tasks/node => 64 tasks

#Which Queue
#PBS -q parsys			 	# This is the only accessible queue for rbs

#PBS -N 64   			# Jobname - it gives the stdout/err filenames
...
mpirun -np 32 mpi.out				# That was compiled on front-end
